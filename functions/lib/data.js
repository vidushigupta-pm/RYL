...
exports.normaliseIngredientName = normaliseIngredientName;
exports.lookupIngredient = lookupIngredient;
exports.batchLookupIngredients = batchLookupIngredients;
...
function batchLookupIngredients(ingredientNames) {
    const verified = [];
    const unverified = [];
